...
/**
 * Description of List_ProductCategory_SiteMap
 *
 * @author a.novikov
 */
class List_ProductCategory_SiteMap extends List_ProductCategory_Base_Dropdown {

	/**
	 *
	 * @param ProductCategoryRow $var
	 * @return List_ProductCategory_SiteMap
	 */
