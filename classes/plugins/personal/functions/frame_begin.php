...
function Dwoo_Plugin_frame_begin(Dwoo $dwoo, $file, $cache_time = null, $cache_id = null, $compile_id = null, $data = '_root', $assign = null, array $rest = array())
{
	if ($file === '') {
		return;
	}
	
	$file = "../../../../../layouts/frames/" . $file . "_begin.tpl";
